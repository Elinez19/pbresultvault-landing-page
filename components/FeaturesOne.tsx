  ...
  return (
    <div className="max-w-4xl mx-auto px-5 mt-16">
      <div className="text-center">
        <h2 className="font-semibold text-3xl">Features you will love</h2>
      ...
      <div className="grid md:grid-cols-2 gap-10 mt-10">
        <div className="flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-500">
              {" "}
              You do not need to be an expert to customize this plugin. Our code
        ...
        <div className="flex gap-4 items-start">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-500">
              {" "}
              With mobile, tablet &amp; desktop support it does not matter what
              device you are using. This plugin is responsive in all browsers.{" "}
            </p>
          </div>
        </div>
